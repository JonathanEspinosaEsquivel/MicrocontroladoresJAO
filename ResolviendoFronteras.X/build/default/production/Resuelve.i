             ...
             while(1){
                   ...
                   if(D1>15&&D2<15&&D3<15){
                      ...
                      _delay((unsigned long)((150)*(32000000/4000.0)));
                       ...
                       LATCbits.LATC2=1;
                       LATCbits.LATC3=0;
                        _delay((unsigned long)((750)*(32000000/4000.0)));
                       LATCbits.LATC4=1;
                       LATCbits.LATC5=0;
                       LATCbits.LATC2=1;
                       LATCbits.LATC3=0;
                   ...
                   if(D1<15&&D2<15&&D3<15){
                       ...
                       LATCbits.LATC2=1;
                       LATCbits.LATC3=0;
                       _delay((unsigned long)((950)*(32000000/4000.0)));
                       LATCbits.LATC4=1;
                       LATCbits.LATC5=0;
                       LATCbits.LATC2=1;
                       LATCbits.LATC3=0;
             ...
             while(1){
               ...
               if(azar==0){
                   ...
                   if((D1<ref1+1)&&(D2<ref2+1)&&(D3>ref3+1)){
                       ...
                       LATCbits.LATC2=1;
                       LATCbits.LATC3=1;
                        _delay((unsigned long)((610)*(32000000/4000.0)));
                       LATCbits.LATC4=1;
                       LATCbits.LATC5=0;
                       LATCbits.LATC2=1;
                       LATCbits.LATC3=0;
                   ...
                   if((D1<ref1+1)&&(D2<ref2+1)&&(D3<ref3)){
                       ...
                       LATCbits.LATC2=0;
                       LATCbits.LATC3=1;
                       _delay((unsigned long)((700)*(32000000/4000.0)));
                          LATCbits.LATC4=1;
                       LATCbits.LATC5=0;
                       LATCbits.LATC2=1;
                       LATCbits.LATC3=0;
                   ...
                   D3=distancia3();
                    ...
                    if((D1>ref1+5)&&(D2<ref2+2)){
                       ...
                       LATCbits.LATC2=1;
                       LATCbits.LATC3=0;
                       _delay((unsigned long)((690)*(32000000/4000.0)));
                       LATCbits.LATC4=1;
                       LATCbits.LATC5=0;
                       LATCbits.LATC2=1;
                       LATCbits.LATC3=0;
               ...
               if(azar==0){
                 ...
                 if(D2>ref2){
                   ...
                   if(D1>15&&D2<15&&D3<15){
                       ...
                       LATCbits.LATC2=1;
                       LATCbits.LATC3=0;
                        _delay((unsigned long)((710)*(32000000/4000.0)));
                       LATCbits.LATC4=1;
                       LATCbits.LATC5=0;
                       LATCbits.LATC2=1;
                       LATCbits.LATC3=0;
                       _delay((unsigned long)((110)*(32000000/4000.0)));
                   D1=distancia1();
                   D2=distancia2();
                   D3=distancia3();
                   }
                   ...
                   D3=distancia3();
                    ...
                    if(D3>20){
                         CCPR1=900;
                       CCPR2=900;
                       _delay((unsigned long)((138)*(32000000/4000.0)));
                       LATCbits.LATC4=1;
                       LATCbits.LATC5=0;
                       LATCbits.LATC2=1;
                       LATCbits.LATC3=1;
...
int distancia2(void){
    ...
    float t=0;
      ...
      while(!PORTAbits.RA3);
      T1CONbits.ON=1;
      while(PORTAbits.RA3==1 && PIR4bits.TMR1IF==0);
          T1CONbits.ON=0;
          a=TMR1;
          TMR1=0;
        t=(0.000001)*(a)/2;
...
int distancia3(void){
      ...
      while(!PORTAbits.RA5);
      T1CONbits.ON=1;
      while(PORTAbits.RA5==1 && PIR4bits.TMR1IF==0);
          T1CONbits.ON=0;
          a=TMR1;
          TMR1=0;
        t=(0.000001)*(a)/2;
